...
G4VPhysicalVolume *SimpleProgramDetectorConstruction::Construct() {
    ...
    G4Box *solidDetector1 = new G4Box("Detector_1_Box", 1 * mm, 1 * m, 1 * m);
    G4LogicalVolume *logicDetector1 = new G4LogicalVolume(solidDetector1, si, "Detector1Log");
    new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logicDetector1, "Detector1", logicWorld, false, 0, true);

    G4Box *solidDetector2 = new G4Box("Detector_2_Box", 10 * mm, 1 * m, 1 * m);
    G4LogicalVolume *logicDetector2 = new G4LogicalVolume(solidDetector2, si, "Detector2Log");
    new G4PVPlacement(0, G4ThreeVector(5.5, 0, 0), logicDetector2, "Detector2", logicWorld, false, 0, true);
